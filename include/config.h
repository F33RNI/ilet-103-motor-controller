...
// Uncomment to receive rpm_setpoint_filtered, rom_filtered and pid_output separated by tab (/t) at 115200
// #define DEBUG
...
// PID values
const float PID_P_GAIN = .0008f;
const float PID_I_GAIN = .0036f;
const float PID_D_GAIN = .000004f;
